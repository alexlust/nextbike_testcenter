...
class SingleTariffByCodeContext extends BaseContext implements Context, SnippetAcceptingContext
{
     ...
     */
    public function iWillGetOneTariffOfASpecifiedCode()
    {
        var_dump($this->response);
        //TODO: check all changes;
        $this->assertEquals($this->getIfIsset('code', $this->updateInformation), $this->response['tariff']['@attributes']['code']);
        $this->assertEquals('1090', $this->response['tariff']['@attributes']['uid']);
